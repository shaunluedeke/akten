    ...
    <center>
        ...
        <div class="inter" style="width: 80%;position: absolute;top: 100px;left: 50%;transform: translate(-50%, 0%);">
            <table id="Table" class="table table-striped table-dark" style="width: 100%;" data-toggle="table"
                ...
                {/loop vehicle_loop}
                <tr aria-sort="none"><td colspan="6" style="text-align: center"><a class="btn btn-success" href="index.php?site=vehicle-add">Hinzufügen</a></td></tr>
                </tbody>
            </table>
        </div>
    </center>
...
{if not hasperson}
        <div id="content">
                ...
                <table class="table table-responsive-lg table-bordered table-dark">
                    ...
                    {/if wanted1}
                    <p><a class="btn btn-success" href="index.php?site=vehicle-edit&id={id}">Daten ändern</a></p>
                <a class="btn btn-danger" href="index.php?site=vehicle">Zurück</a>
            </div>
        </div>
{/if not hasperson}
