...
<div id="content">
    ...
    <div class="form">
        ...
        <form action="index.php?site=vehicle-add" enctype="multipart/form-data" method="POST">
            <div class="form-group">
                <label for="exampleInputEmail1">Kennzeichen</label>
                <input type="text" class="form-control" name="number" placeholder="Kennzeichen" required >
            </div><br>
            <div class="form-group">
                <label for="exampleInputEmail1">Halter</label>
                <input type="text" class="form-control" name="owner" placeholder="Halter">
            </div><br>
            <div class="form-group">
                <label for="exampleInputEmail1">Telefonnummer</label>
                <input type="number" class="form-control" name="tel" placeholder="Telefonnummer">
            </div><br>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="color" placeholder="Farbe">
            </div><br>
            <div class="form-group">
            ...
            <p><a class="btn btn-danger" href="index.php?site=vehicle">Zurück</a>
                <button type="submit" name="addvehicle" class="btn btn-primary">Speichern</button></p>
