    ...
    <center>
      ...
      <div class="inter" style="width: 70%;position: absolute;top: 50%;left: 50%;transform: translate(-50%, 0%);">
        <table id="Table" class="table table-striped table-dark" style="width: 100%;" data-toggle="table" data-pagination="true"
          ...
          <tbody>
          {loop account_loop}
            <th scope="row">{account_loop_user}</th>
            <td>{account_loop_rang}</td>
            <td>{account_loop_fraction}</td>
            <td><a class="btn btn-primary" href="index.php?site=usercheck&name={account_loop_user}">INFO</a></td>
          {endloop account_loop}
