...
<body>
<script type="text/javascript" color="76, 209, 55" opacity="1.4" zindex="-2" count="100"
            ...
            <div class="pricing-table">
                <div class="col">
                    ...
                    <div class="table">
                        ...
                        <div class="loschen">
                            <a href="index.php?site=edituser&name={name2}">Edit</a>
                        </div>
                        <div class="loschen">
                            <a href="index.php?site=deleteuser&name={name3}">Löschen</a>
                        </div>
                    </div>
                </div>
            </div>
