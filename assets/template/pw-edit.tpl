...
<form action="index.php?site=pw-edit" method="POST" class="login-form">
  <h1>Password andern</h1>

  <div class="txtb">
    <input type="password" name="pwalt" required>
  ...
  <input type="submit" class="logbtn" name ="pwedit" value="Ändern">
