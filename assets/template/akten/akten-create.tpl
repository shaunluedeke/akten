...
<div id="content">
    ...
    <div class="form">
        ...
        <form action="index.php?site=akten-create&frac=pd" method="POST">
            ...
            <br>
            <div class="form-group">
                <label for="exampleInputEmail1">Einreise datum</label>
                <input type="text" class="form-control" name="gb" value="" placeholder="Einreise datum">
            </div>
            <br>
            <div class="form-group">
                <label for="exampleInputEmail1">Telefonnummer</label>
                <input type="number" class="form-control" name="tel" value="555" placeholder="555">
            </div>
            <br>
            <div class="form-group">
        ...
        <form action="index.php?site=akten-create&frac=md" method="POST">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Einreise datum</label>
                <input type="text" class="form-control" name="gb" placeholder="Einreise datum">
            </div>
            <br>
            <div class="form-group">
                <label for="exampleInputEmail1">Telefonnummer</label>
                <input type="text" class="form-control" name="tel" value="555" placeholder="555">
            </div>
            <br>
            <div class="form-group">
                <label for="exampleInputEmail1">Wann ist es Passiert</label>
