...
<div id="content">
    ...
    <div class="login-form" style="text-align: center;">
        <h3 style="color: black">Möchtest du die <br>Akte wirklich löschen</h3>
        <br><br><br><br>
        <p><a class="btn btn-warning" href="index.php?site=akten-delete&id={id}&state=confirm">Akte Löschen</a></p>
